...
| 28 | [`docs/28_ETAT_D_AVANCEMENT.md`](docs/28_ETAT_D_AVANCEMENT.md) | **État d'avancement mesuré** : étendue fonctionnelle ≈ 49 %, profondeur de preuve ≈ 76 %, et ce que le chiffre ne mesure pas | vous voulez savoir où en est le projet |
...
**533 tests passent**, dont 97 écrits pour l'audit et la red team.
