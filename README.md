...
quatorze outils, mémoire, journal interrogeable — sans Internet et sans aucun modèle
installé.
...
`memory_add`, `memory_search`, `memory_forget`, `task_create`, `task_list`, `note_create`,
